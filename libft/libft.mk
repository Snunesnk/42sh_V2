...
#    Updated: 2020/04/18 15:05:55 by abarthel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
override CFLAGS += -Wall -Werror -Wextra -ansi -std=c99 -D_POSIX_C_SOURCE -fno-builtin -O2 -g3 -fsanitize=address,undefined
