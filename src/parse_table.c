...
/*   Updated: 2020/04/16 16:32:05 by abarthel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	g_token_start[] = {
	GREATAND, LESSAND, DGREAT, DLESS, GREAT, LESS, NEWLINE, IO_NB,
	WORD, NONE
};
int	g_token_word[] = {
	SEMI, OR_IF, PIPE, AND_IF, GREATAND, LESSAND, ANDGREAT, AND, DGREAT,
	DLESS, GREAT, LESS, NEWLINE, IO_NB, WORD, NONE
};
int	g_token_io_nb[] = { GREATAND, LESSAND, DGREAT, DLESS, GREAT, LESS, NONE };
int	g_token_if[] = {
	GREATAND, LESSAND, DGREAT, DLESS, LESS, GREAT, IO_NB, WORD, NONE
};
